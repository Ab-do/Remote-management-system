...
void InfoContact()
{
  ...
  if (StateContact1 == LOW && contact1 == false && millis() - last > 400) {
    HC12.println("J" + String(PINCODE + 4));
     delay(12500); // déccélération
    contact1 = true;
    last = millis();
  } else if (StateContact1 == HIGH && contact1 == true && millis() - last > 400) {
    HC12.println("J" + String(PINCODE + 3));
     delay(50); // déccélération
    contact1 = false;
    last = millis();
  }
  ...
  if(Obj==4){
    ...
    if (StateContact2 == LOW && contact2 == false && millis() - last > 400)
      {
      HC12.println("J" + String(PINCODE + 1003));
      contact2 = true;
      last = millis();
      }else if(StateContact2 == HIGH && contact2 == true && millis() - last > 400)
     {
